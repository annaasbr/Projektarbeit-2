...
background_image = ctk.CTkImage(
    light_image=Image.open("hintergrund.png"),
    size=(1200, 800)
)
...
# Create the frame
frameStartseite = ctk.CTkFrame(root, fg_color="#ffffff", width=800, height=600, corner_radius=20)
frameStartseite.place(relx=0.5, rely=0.5, anchor="center")

# Add background image inside it
image = ctk.CTkImage(Image.open("hintergrund.png"), size=(1200, 800))
image_label = ctk.CTkLabel(frameStartseite, image=image, text="")
image_label.place(x=0, y=0, relwidth=1, relheight=1)


# All other frames should be children of frameStartseite


frameAnmelden = ctk.CTkFrame(frameStartseite, fg_color="#ffffff", width=600, height=400, corner_radius = 20 )
...
image2 = ctk.CTkImage(Image.open("hintergrund.png"), size=(400, 830))
image_label2 = ctk.CTkLabel(frameAnmelden, image=image, text="")
image_label2.place(x=0, y=0, relwidth=1, relheight=1)
...
labelAnmelden = ctk.CTkLabel(frameAnmelden, text="Anmelden!", 
                          font=ctk.CTkFont(size= 28, weight="bold"),image=ctk_image, compound="center", 				   fg_color="transparent")
